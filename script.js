...
const eidGreetings = [
        ...
        `يا ${name}، أسأل الله أن يملأ قلبك نوراً وإيماناً في هذا العيد وكل عيد`,
        `عيد أضحى مبارك يا ${name}، جعله الله فرصة للتوبة والمغفرة والتقرب إليه`,
        `اللهم بارك لـ ${name} في عيده، واجعله من عتقائك من النار`,
        `يا ${name}، كل عام وأنت أقرب إلى الله، وأكثر طاعة ورضا`,
        `تقبل الله أضحيتك يا ${name}، وجعلها قرباناً خالصاً لوجهه الكريم`,
        `عيدك مبارك يا ${name}، ونسأل الله أن يرزقك حج بيته الحرام قريباً`,
        `اللهم اجعل عيد ${name} عيد خير وبركة، وأمن وأمان على الأمة الإسلامية`,
        `يا ${name}، في هذا اليوم المبارك، لا تنسَ ذكر الله وشكره على نعمه`,
        `عيد أضحى سعيد يا ${name}، أدام الله عليك الصحة والعافية وراحة البال`,
        ...
        `يا ${name}، الخروف بيقولك كل سنة وانت طيب، بس ابقى افتكرني بقطعة لحمة حلوة 😉`,
        `عيد سعيد يا ${name}! لو اللحمة خلصت، لسه فيه فتة... متقلقش 😂`,
        `يا ${name}، نصيحة العيد: كل اللحمة اللي تقدر عليها، الدايت يبدأ بعد العيد (أو لا يبدأ أبداً 😜)`,
        `يا ${name}، العيدية السنة دي عبارة عن دعوات بإنك متتخنش من اللحمة 🤲`,
        `خروف العيد بيسأل عليك يا ${name}، بيقول وحشته السنة اللي فاتت 🤣`,
        `يا ${name}، لو حسيت بتقل بعد الأكل، افتكر إن ده عيد اللحمة مش عيد السلطة 🥗➡️🥩`,
        `كل سنة وانت طيب يا ${name}، ويا رب العيد الجاي تكون لسه فاكر طعم اللحمة دي 😂`,
        `يا ${name}، العيد ده برعاية الكوليسترول والدهون الثلاثية... استمتع! 🥳`,
        `يا ${name}، لو الخروف اتكلم كان قالك: ارحمني يا ${name}! 🐑`,
        `عيدك مبارك يا ${name}، بس حاول تسيب حتة لحمة لبكرة 😅`,
        ...
        `يا ${name}، أتمنى لك عيداً يملأ قلبك بالسعادة والسرور 💖`,
        `كل عام وأنت الفرحة لقلوبنا يا ${name}، عيد سعيد عليك وعلى أحبابك`,
        `عيد أضحى مبارك يا ${name}، أتمنى لك أياماً بيضاء كقلبك النقي 🤍`,
        `يا ${name}، وجودك في حياتنا عيد بحد ذاته، كل سنة وانت معانا`,
        `أتمنى لك يا ${name} عيداً مليئاً بالضحكات واللحظات الجميلة التي لا تُنسى 😄`,
        `عيد سعيد يا ${name}! أرسل لك باقة ورد معطرة بأجمل التهاني 💐`,
        `يا ${name}، كل عام وأنت بخير وسعادة، وتحقق كل أمانيك`,
        `في هذا العيد المبارك، أتمنى لك يا ${name} كل التوفيق والنجاح في حياتك`,
        `عيد أضحى سعيد يا ${name}، أدام الله عليك بهجة الأعياد دهوراً عديدة 🎉`,
